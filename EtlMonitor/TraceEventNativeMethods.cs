...
namespace Microsoft.VisualStudio.Telemetry.ETW
{
    ...
    internal unsafe static class TraceEventNativeMethods
    {
        ...
        internal enum TRACE_INFO_CLASS
        {
            ...
            TraceProfileSourceConfigInfo,           // int array
            TraceProfileSourceListInfo,             // PROFILE_SOURCE_INFO array
            TracePmcEventListInfo,                  // Works like TraceStackTracingInfo (CLASSIC_EVENT_ID array)
        ...
        */
        ...
        internal static unsafe void CopyStringToPtr(char* toPtr, string str)
        {
